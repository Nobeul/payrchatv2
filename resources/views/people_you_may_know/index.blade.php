                        ...
                        <div>
                            <div class="sl_find_frns_user">
                                ...
                                <div class="sl_find_frns_user_info">
                                    ...
                                    <h4> <a href="timeline.html"> {{ $user->first_name }} {{ $user->last_name }} </a> </h4>
